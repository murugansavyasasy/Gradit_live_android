...
public class PunchStaffAttendanceUsingFinger extends AppCompatActivity implements GPSStatusListener, LocationLatLongListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Remove system ActionBar since you’re using custom layout
        if (getSupportActionBar() != null) {
            getSupportActionBar().hide();
        }

        // Access your custom actionbar elements directly from layout
        ...
        rytPresentlayout = findViewById(R.id.rytPresentlayout);
        rytAddLocation = findViewById(R.id.rytAddLocation);
        rytMarkAttendanceSceen = findViewById(R.id.rytMarkAttendanceSceen);
        rytAttendanceHistorySceen = findViewById(R.id.rytAttendanceHistorySceen);
        rytProgressBar = findViewById(R.id.rytProgressBar);
        rytEnableFingerPrint = findViewById(R.id.rytEnableFingerPrint);
        ...
        recycleAttendanceReports = findViewById(R.id.recycleAttendanceReports);

        rytYears = findViewById(R.id.rytYears);
        rytMonths = findViewById(R.id.rytMonths);
