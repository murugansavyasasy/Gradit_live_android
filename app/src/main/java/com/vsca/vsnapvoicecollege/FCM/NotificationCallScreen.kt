...
class NotificationCallScreen : BaseActivity<NotificationCallScreenBinding>(), View.OnClickListener {
    ...
    override fun inflateBinding(): NotificationCallScreenBinding {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val circularId = intent.getStringExtra("circularId")
    ...
    override val layoutResourceId: Int
        get() = R.layout.notification_call_screen
    ...
    private fun updateNotificationCallLog(start: String, end: String) {
        ...
        val MobileNumber: String? = SharedPreference.getSH_MobileNumber(this)
