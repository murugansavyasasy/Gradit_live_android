...
class ResumeBuilderAssessmentDetailsAdapter(private val items: List<GetAssessmentDetailsData>) :
    RecyclerView.Adapter<ResumeBuilderAssessmentDetailsAdapter.ViewHolder>() {
