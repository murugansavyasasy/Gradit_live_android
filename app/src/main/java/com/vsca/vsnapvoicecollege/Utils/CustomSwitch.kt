...
class CustomSwitch @JvmOverloads constructor(
    ...
    private val activeColor = ContextCompat.getColor(context, R.color.dark_blue)
    private val inactiveColor = ContextCompat.getColor(context, R.color.grey_rect)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawRoundRect(
            0f, 0f, switchWidth, switchRadius * 2, switchRadius, switchRadius, backgroundPaint
        )
